...
# ####
# ## Start S3 Copy to filesystem
# echo "Step 1:Downloading the jsq files from S3 bucket"
# aws s3 cp $S3_JSQ_INPUT_FULL_PATH $LOCAL_JSQ_INPUT_FULL_PATH --recursive
# ## End S3 Copy to filesystem
# ####
